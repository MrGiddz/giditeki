...
const testimonials = [
  {
    ...
    hint: 'woman portrait',
    quote:
      'Apex Digital transformed our operations. Their expertise in cloud solutions was a game-changer for our business, improving our efficiency by over 40%.',
  },
  {
    name: 'Michael Chen',
    title: 'CTO, TechGurus',
...
export default function Home() {
  return (
    <div className="flex flex-col">
      <section id="hero" className="relative overflow-hidden py-20 text-center sm:py-32">
        <AnimatedBackground />
        <motion.div
